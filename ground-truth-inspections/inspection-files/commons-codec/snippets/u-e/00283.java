public class PhoneticEngine {
    private static final class RulesApplication {
        ...
        public PhonemeBuilder getPhonemeBuilder() { // definition of b
    ...
    public String encode(String input, final Languages.LanguageSet languageSet) {
        ...
        for (int i = 0; i < input.length();) {
            ...
            i = rulesApplication.getI(); // NullPointerException here
            phonemeBuilder = rulesApplication.getPhonemeBuilder(); // call to b
        }
    ...
    private PhonemeBuilder applyFinalRules(final PhonemeBuilder phonemeBuilder,
        ...
        for (final Rule.Phoneme phoneme : phonemeBuilder.getPhonemes()) {
            ...
            for (int i = 0; i < phonemeText.length();) {
                ...
                subBuilder = rulesApplication.getPhonemeBuilder(); // call to b
...
public class BeiderMorseEncoderTest extends StringEncoderAbstractTest<StringEncoder> {
    ...
    public void testAsciiEncodeNotEmpty1Letter() throws EncoderException { // unknown verdict test
        ...
        for (char c = 'a'; c <= 'z'; c++) {
            ...
            assertNotEmpty(bmpm, value); // calls a and b
            assertNotEmpty(bmpm, valueU); // calls a and b
        }
    }

    private void assertNotEmpty(final BeiderMorseEncoder bmpm, final String value) throws EncoderException { // called from validating test
        Assert.assertFalse(value, bmpm.encode(value).equals("")); // calls a and b
    }
    ...
    public void testAllChars() throws EncoderException { // error verdict test
        ...
        for (char c = Character.MIN_VALUE; c < Character.MAX_VALUE; c++) {
            bmpm.encode(Character.toString(c)); // calls a and b
        }
    }
}
