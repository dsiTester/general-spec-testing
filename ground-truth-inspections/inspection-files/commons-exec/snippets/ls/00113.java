    ...
    public void execute(final CommandLine command, final Map<String, String> environment,
        ...
        final Runnable runnable = new Runnable()
        {
            ...
            public void run()
            {
                ...
                try {
                    exitValue = executeInternal(command, environment, workingDirectory, streamHandler); // calls b (called after thread is started)
        ...
        getExecutorThread().start(); // call to a
    }

    private int executeInternal(final CommandLine command, final Map<String, String> environment,
            final File dir, final ExecuteStreamHandler streams) throws IOException { // called from Runnable called by thread retrieved by calling a
