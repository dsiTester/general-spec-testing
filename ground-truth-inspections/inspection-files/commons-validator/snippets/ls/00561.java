public class DateValidator extends AbstractCalendarValidator {
     ...
     */
    public Date validate(String value, String pattern, TimeZone timeZone) { // definition of a
     ...
     * @return The parsed <code>Date</code> if valid or <code>null</code> if invalid.
     */
    public Date validate(String value, String pattern, Locale locale, TimeZone timeZone) { // definition of b
...
public class DateValidatorTest extends AbstractCalendarValidatorTest {
    ...
    public void testDateValidatorMethods() {
        ...
        assertEquals("validate(C) pattern", expectedZone, DateValidator.getInstance().validate(patternVal, pattern, zone)); // call to a
        assertEquals("validate(C) both",    expectedZone, DateValidator.getInstance().validate(germanVal, germanPattern, Locale.GERMAN, zone)); // call to b
    }
}
