public class ValidatorAction implements Serializable {
        ...
        try {
            if (this.validationMethod == null) {
                synchronized(this) {
                    ...
                    this.loadValidationClass(loader); // would throw NullPointerException; refer to below
    ...
    private void loadValidationClass(ClassLoader loader)
        ...
        try {
            this.validationClass = loader.loadClass(this.classname); // would throw NullPointerException here if a was not called by this point
