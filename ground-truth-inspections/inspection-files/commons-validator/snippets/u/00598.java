...
public abstract class AbstractFormatValidator implements Serializable {
     ...
     * @return The value formatted as a <code>String</code>.
     */
    public String format(Object value) { // definition of b
...
public class TimeValidatorTest extends TestCase {
    ...
    public void testFormat() {
        ...
        assertEquals("Format locale",  "4:49 PM",  validator.format(test, Locale.US)); // call to a
        assertEquals("Format default", "16:49",  validator.format(test)); // call to b
