...
IN_FILE=${BASE_DIR}/data/analysis-data/new-dsi-accuracies.csv
# hack. should I do this here or elsewhere?
REORGANIZED_IN_FILE=${BASE_DIR}/data/analysis-data/reorganized-new-dsi-accuracies.csv
REORGANIZED_IN_FILE_TEMP=${BASE_DIR}/data/analysis-data/tmp-reorganized-new-dsi-accuracies.csv
...
MACROS_IDENT=newOriginalDsiAccuracySummary # script-specific macro header to prevent crashes

MACROS_DIR=${PAPER_DIR}/generated-macros
TABLES_DIR=${PAPER_DIR}/tables

MACROS_FILE_IDENT=new_dsi_accuracy_summary_table_macros
MACROS_OUT=${MACROS_DIR}/new_dsi_accuracy_summary_table_macros.tex
MACROS_STARTER=${MACROS_DIR}/new_dsi_accuracy_summary_table_macros_starter.tex
TABLES_OUT=${TABLES_DIR}/new_dsi_accuracy_summary_table.tex
...
"
# \label{tabular:output:new_dsi_accuracy}
# \end{center}
# \vspace{-10pt}
# \end{table}
