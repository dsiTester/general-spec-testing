public class ItemInputStream extends InputStream implements Closeable {
    ...
    public int discardBodyData() throws MalformedStreamException, IOException {
        return readBodyData(null); // call to a; calls b
    }

    public int readBodyData(OutputStream output)
        throws MalformedStreamException, IOException { // definition of a
        return (int) Streams.copy(newInputStream(), output, false); // call to b
    }

    ItemInputStream newInputStream() { // definition of b
