public class ExecuteWatchdog implements TimeoutObserver {
     ...
     */
    @Override
    public synchronized void timeoutOccured(final Watchdog w) { // definition of a
        try {
            try {
    ...
    public synchronized void destroyProcess() { // called from test
        ensureStarted();
        this.timeoutOccured(null); // call to a
        this.stop();
    }
...
public class DefaultExecutorTest {
    ...
    public void testExecuteAsyncWithProcessDestroyer() throws Exception {
      ...
      watchdog.destroyProcess(); // call a and b
      assertTrue(watchdog.killedProcess()); // assertion fails here
