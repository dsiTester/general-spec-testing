public class DefaultExecutor implements Executor {
    ...
    private int executeInternal(final CommandLine command, final Map<String, String> environment,
            final File dir, final ExecuteStreamHandler streams) throws IOException {  // called from b; uses the argument streamHandler to connect the outputstreams between the processes
