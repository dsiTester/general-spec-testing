...
public class DefaultExecutor implements Executor {
    ...
    public void execute(final CommandLine command, final ExecuteResultHandler handler)
        ...
        execute(command, null, handler);           // creates thread that potentially uses DefaultExecutor.processDestroyer
    }

    @Override
    public void execute(final CommandLine command, final Map<String, String> environment,
            final ExecuteResultHandler handler) throws ExecuteException, IOException { // called from b
