...
public class DefaultExecutor implements Executor {
    ...
    public void execute(final CommandLine command, final Map<String, String> environment,
        ...
        final Runnable runnable = new Runnable()
        {
            ...
            public void run()
            {
                ...
                try {
                    exitValue = executeInternal(command, environment, workingDirectory, streamHandler); // passing in DefaultExecutor.streamHandler, where it will be used
        ...
        getExecutorThread().start(); // starting above thread
    }
    ...
    private int executeInternal(final CommandLine command, final Map<String, String> environment,
            final File dir, final ExecuteStreamHandler streams) throws IOException { // called from the thread setup and started by b. Note that whatever value of DefaultExecutor.streamHandler by this point is set as the final argument streams.
