public class CalendarValidator extends AbstractCalendarValidator {
     ...
     */
    public Calendar validate(String value, String pattern, TimeZone timeZone) { // definition of b
...
public class CalendarValidatorTest extends AbstractCalendarValidatorTest {
    public void testCalendarValidatorMethods() {
        ...
        assertEquals("validate(C) locale ", expectedZone, CalendarValidator.getInstance().validate(localeVal, locale, zone).getTime()); // call to a
        assertEquals("validate(C) pattern", expectedZone, CalendarValidator.getInstance().validate(patternVal, pattern, zone).getTime()); // call to b
