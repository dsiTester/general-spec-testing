public class DefaultExecutor implements Executor {
    ...
    public int execute(final CommandLine command, final Map<String, String> environment)
        ...
        return executeInternal(command, environment, workingDirectory, streamHandler); // uses the argument streamHandler to connect the outputstreams between the processes

    }

    private int executeInternal(final CommandLine command, final Map<String, String> environment,
            final File dir, final ExecuteStreamHandler streams) throws IOException {  // called from above; uses the argument streamHandler to connect the outputstreams between the processes
...
public class DefaultExecutorTest {
    ...
    public void testExecuteWithRedirectedStreams() throws Exception { // validated test
        if (OS.isFamilyUnix()) {
            ...
            final int exitValue = executor.execute(cl);   // call to b
            fis.close();
