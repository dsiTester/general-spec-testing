...
public class DiskFileUploadTest {
    ...
    public void testMoveFile() throws Exception {
        ...
        final List<FileItem> items = myUpload.parseRequest(request); // calls bb
        assertNotNull(items);
    ...
    public List<FileItem> parseRequest(RequestContext ctx)
        ...
        try {
            ...
            while (iter.hasNext()) {
                ...
                FileItem fileItem = fac.createItem(item.getFieldName(), item.getContentType(), item.isFormField(), fileName); // calls b
                items.add(fileItem);
                ...
            }
            ...
