public class FileUploadBase {
    ...
    protected String getFieldName(FileItemHeaders headers) { // definition of b
        return getFieldName(headers.getHeader(CONTENT_DISPOSITION)); // call to argument caused NullPointerException
    }

    private String getFieldName(String pContentDisposition) { // called from b
    ...
    private boolean findNextItem() throws IOException {
        ...
        for (;;) {
            ...
            if (currentFieldName == null) {
                ...
                String fieldName = getFieldName(headers); // call to b; NullPointerException happens here too
                if (fieldName != null) {
                    ...
                }
            } else {
