...
public class ServletFileUpload extends FileUpload {
    ...
    public List<FileItem> parseRequest(HttpServletRequest request)
        ...
        return parseRequest(new ServletRequestContext(request)); // will throw exception (expected) if file size is larger than fileSizeMax (set by a)
    }
}
...
public class SizesTest {
    ...
    public void testFileSizeLimit()
        ...
        List<FileItem> fileItems = upload.parseRequest(req); // call to b
        ...
        ...
        fileItems = upload.parseRequest(req); // call to b
        ...
    ...
    public void testFileSizeLimitWithFakedContentLength()
        ...
        req = new MockHttpServletRequest(request.getBytes("US-ASCII"), Constants.CONTENT_TYPE);
        try {
            upload.parseRequest(req); // call to b; however DSI experiment couldn't get to this point.
