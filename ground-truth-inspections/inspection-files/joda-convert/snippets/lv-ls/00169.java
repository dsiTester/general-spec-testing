...
public TypedStringConverter<Object> findTypedConverterNoGenerics(final Class<?> cls) {//method b
    TypedStringConverter<Object> conv = (TypedStringConverter<Object>) findConverterQuiet(cls);//relies on registered converters
    if (conv == null) {
...
public StringConvert(boolean includeJdkConverters, StringConverterFactory... factories) {
    ...
    if (includeJdkConverters) {
        ...
        tryRegisterTimeZone();
        tryRegisterJava8();
        tryRegisterThreeTenBackport();//method a, note the other converters
