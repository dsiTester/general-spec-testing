    ...
    private void loadValidationMethod() throws ValidatorException { // definition of b
        ...
        try {
            this.validationMethod =
                this.validationClass.getMethod(this.method, this.parameterClasses); // throws NullPointerException here if a and ValidatorAction.loadParameterClasses() was not called by this point
        ...
        try {
            if (this.validationMethod == null) {
                synchronized(this) {
                    ...
                    this.loadValidationMethod(); // call to b; throws ValidatorException here
                }
            }
