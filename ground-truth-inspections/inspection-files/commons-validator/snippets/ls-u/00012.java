...
public class RequiredNameTest extends AbstractCommonTest {
   ...
   protected void setUp() throws IOException, SAXException {
      // Load resources
      loadResources("RequiredNameTest-config.xml"); // calls a; defined in AbstractCommonTest
   }
...
protected void setUp() throws IOException, SAXException {
      // Load resources
      loadResources("RequiredIfTest-config.xml"); // calls a; defined in AbstractCommonTest
   }
