public class ValidatorResources implements Serializable {
    ...
    public void process() {     // definition of b
        ...
        this.processForms();    // definition below
    }
     ...
     * <code>FormSet</code>.</p>
     */
    private void processForms() {     // called from b
    ...
    public ValidatorResources(InputStream[] streams)
            throws IOException, SAXException { // indirectly called from ValidatorResources() in validating test
