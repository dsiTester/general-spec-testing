...
public class PercentCodecTest {
    ...
    public void testUnsafeCharEncodeDecode() throws Exception { // validated test
        ...
        final byte[] decoded = percentCodec.decode(encoded); // calls b; throws exception
    ...
    public void testDecodeInvalidEncodedResultDecoding() throws Exception { // invalidated test
        ...
        try {
            percentCodec.decode(Arrays.copyOf(encoded, encoded.length-1)); // calls b; exclude one byte
