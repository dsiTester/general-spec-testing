...
public void test_registerFactory() {
    ...
    assertEquals(DistanceMethodMethod.class, test.findTypedConverter(DistanceMethodMethod.class).getEffectiveType());//method-b
}
...
public StringConvert(boolean includeJdkConverters, StringConverterFactory... factories) {//the default constructor has factories by default
    ...
    if (includeJdkConverters) {
        ...
        this.factories.add(TypeStringConverterFactory.INSTANCE);//generic case
    }
}
