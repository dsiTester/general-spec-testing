package com.runtimeverification.rvmonitor.logicrepository.fsmplugin;
...
import com.runtimeverification.rvmonitor.logicrepository.fsmplugin.ast.State;
import com.runtimeverification.rvmonitor.logicrepository.fsmplugin.ast.Symbol;
import com.runtimeverification.rvmonitor.logicrepository.fsmplugin.parser.FSMParser;
...
public class FSMPlugin extends LogicPlugin {
    ...
    public LogicRepositoryType process(LogicRepositoryType logicInputXML) throws LogicException {
        Log.write("In FSMPlugin", "");

        String acc = "";
        for (String m : logicInputXML.getMessage()) {
            acc = acc + m + "; ";
        }
        ...
        Log.write("FSM going to be minimized", "");
        // minimize the FSM
        ...
        Log.write("FSM logicOutput", logicOutput.toString());
