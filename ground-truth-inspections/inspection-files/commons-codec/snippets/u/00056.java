public class BaseNCodecInputStream {
     ...
     */
    @Override
    public int read(final byte array[], final int offset, final int len) throws IOException { // definition of a/b; Base16InputStream does not define the method
...
public class Base16InputStreamTest {
    ...
    public void testSkipNone() throws IOException {
        ...
        try (final Base16InputStream b16Stream = new Base16InputStream(ins)) {
            ...
            b16Stream.read(actualBytes, 0, actualBytes.length); // call to a
            assertArrayEquals(actualBytes, new byte[] {(byte)202, (byte)254, (byte)186, (byte)190, (byte)255, (byte)255}); // assertion fails here
