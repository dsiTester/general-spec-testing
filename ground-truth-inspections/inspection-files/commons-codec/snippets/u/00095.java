public class BaseNCodecInputStream extends FilterInputStream {
     ...
     */
    @Override
    public int read(final byte array[], final int offset, final int len) throws IOException { // definition of a; not defined in Base32InputStream
     ...
     */
    @Override
    public int read() throws IOException { // definition of b ; not defined in Base32InputStream
        int r = read(singleByte, 0, 1); // (a call to a!)
        while (r == 0) {
...
public class Base32InputStreamTest {
    ...
    public void testSkipNone() throws Throwable {
        ...
        try (final Base32InputStream b32stream = new Base32InputStream(ins)) {
            ...
            b32stream.read(actualBytes, 0, actualBytes.length); // call to a
            assertArrayEquals(actualBytes, new byte[] { 102, 111, 111, 0, 0, 0 }); // assertion fails here
