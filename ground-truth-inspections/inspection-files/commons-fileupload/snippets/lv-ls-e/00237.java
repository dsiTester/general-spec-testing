xpublic class ParameterParser {

    public void setLowerCaseNames(boolean b) { // definition of a
        this.lowerCaseNames = b;
    }

    public Map<String, String> parse(final String str, char separator) { // definition of b; called from ParameterParserTest/DiskFileItem.getCharSet()
        if (str == null) {
    ...
    public Map<String, String> parse(
                                     ...
                                     int offset,
                                     int length,
                                     char separator) { // called from above
...
public class DiskFileItem {
    ...
    @Override
    public String getString() { // called from invalidated test
        ...
...
public class ParameterParserTest {
    ...
    public void testContentTypeParsing() { // validated test
        ...
        ParameterParser parser = new ParameterParser();
        parser.setLowerCaseNames(true); // call to a
        Map<String, String> params = parser.parse(s, ';'); // call to b
