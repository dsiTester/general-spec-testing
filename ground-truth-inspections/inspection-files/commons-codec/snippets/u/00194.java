public class DigestUtils {
     ...
     * @since 1.11
     */
    public byte[] digest(final byte[] data) { // definition of a
        return updateDigest(messageDigest, data).digest();
    }

    public String digestAsHex(final byte[] data) {
        return Hex.encodeHexString(digest(data)); // call to a
    }

    public String digestAsHex(final ByteBuffer data) { // defintion of b
...
public class DigestUtilsTest {
    ...
    public void testSha224_FileAsHex() throws IOException {
        ...
        assertEquals(expected, digestUtils.digestAsHex(allBytes)); // calls a; assertion fails here
