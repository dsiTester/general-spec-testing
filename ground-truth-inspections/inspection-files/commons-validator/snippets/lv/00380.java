    ...
    private void loadValidationMethod() throws ValidatorException { // definition of b
        ...
        try {
            this.validationMethod =
                this.validationClass.getMethod(this.method, this.parameterClasses); // NullPointerException thrown here if a was not called by this point
        ...
        try {
            if (this.validationMethod == null) {
                synchronized(this) {
                    ...
                    this.loadValidationMethod(); // call to b; throws NullPointerException
                }
            }
