public class Var implements Cloneable, Serializable {
     ...
     */
    public boolean isResource() { // definition of a
...
public class VarTest extends AbstractCommonTest {
   public void testVars() {
       ...
       assertFalse("var-1-1 resource is true", var11.isResource()); // call to a
       ...
       assertTrue("var-2-1 resource is false", var21.isResource()); // call to a
       ...
       assertFalse("var-2-2 resource is true", var22.isResource()); // call to a
