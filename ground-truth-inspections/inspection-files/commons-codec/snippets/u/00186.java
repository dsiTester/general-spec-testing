public class DigestUtils {
     ...
     * @since 1.11
     */
    public String digestAsHex(final InputStream data) throws IOException { // definition of b
...
public class DigestUtilsTest {
    ...
    public void testSha224_FileAsHex() throws IOException {
        ...
        try (final FileInputStream inputStream = new FileInputStream(pathname)) {
            assertEquals(expected, digestUtils.digestAsHex(inputStream)); // call to b
        }
