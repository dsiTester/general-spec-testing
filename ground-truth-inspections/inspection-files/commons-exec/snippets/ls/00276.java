    ...
    public void execute(final CommandLine command, final Map<String, String> environment,
        ...
        final Runnable runnable = new Runnable()
        {
            ...
            public void run()
            {
                ...
                try {
                    exitValue = executeInternal(command, environment, workingDirectory, streamHandler); // calls b
        ...
        this.executorThread = createThread(runnable, "Exec Default Executor"); // creates thread for above runnable
        getExecutorThread().start(); // runs the thread, effectively calls b
    }

    private int executeInternal(final CommandLine command, final Map<String, String> environment,
            final File dir, final ExecuteStreamHandler streams) throws IOException { // called from thread created and ran from above.
