public class FileUploadBase {
    private String getFileName(String pContentDisposition) { // definition of a
    ...
    protected String getFileName(FileItemHeaders headers) { // calls a
        return getFileName(headers.getHeader(CONTENT_DISPOSITION)); // call to a
    }
    ...
    public List<FileItem> parseRequest(RequestContext ctx)
        ...
        try {
            ...
            // System.out.println("getFileName: " + getFileName("form-data; name=\"field\""));
            ...
        }
        ...
    }
    ...
    private boolean findNextItem() throws IOException {
        ...
        for (;;) {
            ...
            if (currentFieldName == null) {
                ...
                String fileName = getFileName(headers); // calls a
