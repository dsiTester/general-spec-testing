public class DefaultExecuteResultHandler implements ExecuteResultHandler {
     ...
     */
    @Override
    public void onProcessComplete(final int exitValue) { // used implementation of b
...
public interface ExecuteResultHandler {
   ...
   */
    void onProcessComplete(int exitValue); // b
        ...
        final Runnable runnable = new Runnable()
        {
            ...
            public void run()
            {
                ...
                try {
                    ...
                    handler.onProcessComplete(exitValue); // call to b
