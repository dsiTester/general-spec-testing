public class TimeValidator extends AbstractCalendarValidator {
     ...
     */
    public Calendar validate(String value, String pattern, Locale locale, TimeZone timeZone) { // definition of a
...
public class TimeValidatorTest extends TestCase {
    ...
    public void testTimeZone() {
        ...
        result = validator.validate("31/Dez/05 21-05", "dd/MMM/yy HH-mm", Locale.GERMAN, EST); // call to a
