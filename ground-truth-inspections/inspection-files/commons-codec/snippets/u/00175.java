public class Hex {
     ...
     */
    @Override
    public Object decode(final Object object) throws DecoderException { // definition of a
        if (object instanceof String) {
            return decode(((String) object).toCharArray());
        }
        if (object instanceof byte[]) {
            return decode((byte[]) object); // call to b
        }
     ...
     */
    @Override
    public byte[] decode(final byte[] array) throws DecoderException { // definition of b
