public abstract class AbstractCalendarValidator extends AbstractFormatValidator {
     ...
     */
    public String format(Object value, TimeZone timeZone) { // definition of a
     ...
     * @return The value formatted as a <code>String</code>.
     */
    public String format(Object value, Locale locale, TimeZone timeZone) { // definition of b
        return format(value, (String)null, locale, timeZone);
    }

    public String format(Object value, String pattern, Locale locale, TimeZone timeZone) { // called from a and b
...
public class CalendarValidatorTest extends AbstractCalendarValidatorTest {
    ...
    public void testFormat() {
        ...
        // EST Time Zone
        assertEquals("EST default",  "30/12/05",         calValidator.format(cal20050101, EST)); // call to a
        assertEquals("EST locale",   "12/30/05",         calValidator.format(cal20050101, Locale.US, EST)); // call to b
