public class Field implements Cloneable, Serializable {
     ...
     * @since Validator 1.1
     */
    public Arg getArg(String key, int position) { // called from b
...
public class ExtensionTest extends TestCase {
    public void testOverrideRule() throws ValidatorException {
       ...
       assertTrue("First Name ValidatorResult for the '" + ACTION +"' action should have '" + CHECK_MSG_KEY + " as a key.", firstNameResult.field.getArg(0).getKey().equals(CHECK_MSG_KEY)); // call ot b
