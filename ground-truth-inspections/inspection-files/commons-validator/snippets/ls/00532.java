public abstract class AbstractNumberValidator extends AbstractFormatValidator {
     ...
     */
    @Override
    public boolean isValid(String value, String pattern, Locale locale) { // definition of a and b
...
public abstract class AbstractFormatValidator implements Serializable {
     ...
     * @return <code>true</code> if the value is valid.
     */
    public abstract boolean isValid(String value, String pattern, Locale locale); // a

    public boolean isValid(String value, String pattern) { // called from test
        return isValid(value, pattern, (Locale)null);      // call to a
    }
}
...
public class CurrencyValidatorTest extends TestCase {
    ...
    public void testPattern() {
        ...
        // invalid
        assertFalse("invalid symbol",  validator.isValid(US_DOLLAR + "1,234.567", pattern)); // calls a
