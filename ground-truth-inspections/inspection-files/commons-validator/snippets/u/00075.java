public class Field implements Cloneable, Serializable {
    ...
    private boolean validateForRule(
        ...
        Map<String, Object> params,
        int pos)
        throws ValidatorException { // indirectly called from Validator.validate(); calls a but also called from a (mutual recursion)
        ...
        return va.executeValidationMethod(this, params, results, pos); // calls b via reflection
    }
