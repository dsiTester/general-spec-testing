public class MultipartStream {
    ...
    public boolean skipPreamble() throws IOException { // definition of b
        ...
        try {
            ...
            discardBodyData();  // throws expected exception
    ...
    public int discardBodyData() throws MalformedStreamException, IOException { // called from b
        return readBodyData(null);
    }

    public int readBodyData(OutputStream output)
            throws MalformedStreamException, IOException { // called from above
