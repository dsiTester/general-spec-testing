public abstract class AbstractFormatValidator implements Serializable {
    ...
    public boolean isValid(String value, String pattern) { // definition of a
        return isValid(value, pattern, (Locale)null);      // call to b
    }
     ...
     * @return <code>true</code> if the value is valid.
     */
    public abstract boolean isValid(String value, String pattern, Locale locale); // b
...
public abstract class AbstractNumberValidator extends AbstractFormatValidator {
     ...
     */
    @Override
    public boolean isValid(String value, String pattern, Locale locale) { // used implementation of b
