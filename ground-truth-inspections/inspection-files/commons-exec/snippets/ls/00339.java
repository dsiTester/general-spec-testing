...
public class DefaultExecutor implements Executor {
    ...
    public void execute(final CommandLine command, final ExecuteResultHandler handler)
        ...
        execute(command, null, handler);           // uses DefaultExecutor.watchDog if it is set
    }
    ...
    public void execute(final CommandLine command, final Map<String, String> environment,
        ...
        final Runnable runnable = new Runnable()
        {
            ...
            public void run()
            {
                ...
                try {
                    exitValue = executeInternal(command, environment, workingDirectory, streamHandler); // uses DefaultExecutor.watchDog if it is set
        ...
        getExecutorThread().start(); // starts above Runnable
    }
