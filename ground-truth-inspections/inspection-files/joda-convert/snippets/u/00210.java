static final class EnumStringConverter implements TypedStringConverter<Enum<?>> {
    ...
    @Override
    public String convertToString(Enum<?> en) {//method-a
...
public void test_Enum() {
    ...
    assertEquals("CEILING", test.convertToString(RoundingMode.CEILING));//method-a, we fail here
    assertEquals(RoundingMode.CEILING, test.convertFromString(RoundingMode.class, "CEILING"));//method-b
}
