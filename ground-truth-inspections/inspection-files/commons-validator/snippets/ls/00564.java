public class DateValidator extends AbstractCalendarValidator {
     ...
     */
    public Date validate(String value, TimeZone timeZone) { // definition of a
...
public class DateValidatorTest extends AbstractCalendarValidatorTest {
    ...
    public void testDateValidatorMethods() {
        ...
        assertEquals("validate(C) default", expectedZone, DateValidator.getInstance().validate(defaultVal, zone)); // call to a
