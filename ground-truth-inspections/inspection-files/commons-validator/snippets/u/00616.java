public class TimeValidator extends AbstractCalendarValidator {
     ...
     */
    public Calendar validate(String value, Locale locale, TimeZone timeZone) { // definition of a
...
public class TimeValidatorTest extends TestCase {
    ...
    public void testTimeZone() {
        ...
        result = validator.validate("7:18 PM", Locale.US, EST); // call to a
        assertNotNull("locale result", result);                 // assertion fails here
        ...
        result = null;

        // Locale & Pattern, diff TimeZone
        result = validator.validate("31/Dez/05 21-05", "dd/MMM/yy HH-mm", Locale.GERMAN, EST); // call to b
        assertNotNull("pattern result", result);
        ...
        result = null;
