...
//method-a and convertToString eventually call this method
...
public void test_registerMethodConstructorCharSequence() {
    ...
    assertEquals(d.amount, test.convertFromString(DistanceNoAnnotationsCharSequence.class, "25m").amount);//method b
