public class DefaultExecutor implements Executor {
    ...
    public int execute(final CommandLine command, final Map<String, String> environment)
        ...
        return executeInternal(command, environment, workingDirectory, streamHandler); // launches subprocess to run in DefaultExecutor.workingDirectory
    ...
    private int executeInternal(final CommandLine command, final Map<String, String> environment,
        ...
        ...
        try {
            process = this.launch(command, environment, dir); // launches the subprocess to run in the specified working directory.
        }
