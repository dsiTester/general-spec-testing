public class TimeValidator extends AbstractCalendarValidator {
     ...
     * @return The parsed <code>Calendar</code> if valid or <code>null</code> if invalid.
     */
    public Calendar validate(String value, Locale locale, TimeZone timeZone) { // definition of b
...
public class TimeValidatorTest extends TestCase {
    ...
    public void testTimeZone() {
        ...
        result = validator.validate("16:49", EST); // call to a
        assertNotNull("zone result", result);      // assertion fails here
        ...
        result = null;
        ...
        result = validator.validate("7:18 PM", Locale.US, EST); // call to b
