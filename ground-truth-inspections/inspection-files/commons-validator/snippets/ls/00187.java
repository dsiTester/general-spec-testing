public class TypeBean {
    ...
    public void setShort(String sShort) { // definition of a
        this.sShort = sShort;
    }

    public void setInteger(String sInteger) { // definition of b
...
public class GenericTypeValidatorTest extends AbstractCommonTest {
   public void testFRLocale() throws ValidatorException {
      ...
      info.setByte("12");
      info.setShort("-129"); // call to a
      info.setInteger("1443"); // call to b
      info.setLong("88000");
