public abstract class AbstractCalendarValidator extends AbstractFormatValidator {
     ...
     */
    public String format(Object value, Locale locale, TimeZone timeZone) { // definition of a
        return format(value, (String)null, locale, timeZone); // call to "b"
    }
     ...
     * @return The value formatted as a <code>String</code>.
     */
    public String format(Object value, String pattern, Locale locale, TimeZone timeZone) { // called from a; definition of b
...
public class CalendarValidatorTest extends AbstractCalendarValidatorTest {
    ...
    public void testFormat() {
        ...
        assertEquals("EST locale",   "12/30/05",         calValidator.format(cal20050101, Locale.US, EST)); // call to a; order of assertions
